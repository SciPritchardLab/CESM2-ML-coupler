...
#
# run example:
# ./run_cesm2_derecho.batch.partial-coupling.stochastic-ens.csh "'/glade/work/sungduk/Gunnar/ANNs_energy/ANN_1/ANN_1_CRM_energy_model.txt','/glade/work/sungduk/Gunnar/ANNs_energy/ANN_2/ANN_2_CRM_energy_model.txt','/glade/work/sungduk/Gunnar/ANNs_energy/ANN_3/ANN_3_CRM_energy_model.txt','/glade/work/sungduk/Gunnar/ANNs_energy/ANN_4/ANN_4_CRM_energy_model.txt','/glade/work/sungduk/Gunnar/ANNs_energy/ANN_5/ANN_5_CRM_energy_model.txt','/glade/work/sungduk/Gunnar/ANNs_energy/ANN_6/ANN_6_CRM_energy_model.txt','/glade/work/sungduk/Gunnar/ANNs_energy/ANN_7/ANN_7_CRM_energy_model.txt'" 2013-02-01
...
set pcount         = 1024
set pelayout       = $HOME/repositories/CESM2-neuralnet-UCI/derecho/pelayout_derecho01.xml
...
setenv CASE        CESM2_ANNs_energy_ncpl-48_spcam-dt-20_${REFDATE}_partial-coupling-NOCLDTEND-FLWDS_sENS
...
if ( ! -e ${cb_inp_sub} || ! -e ${cb_inp_div}  || ! -e ${cb_out_scale} ) then
...
./create_newcase --case $CASEROOT  --pecount $pcount --pesfile $pelayout --compiler intel --res $CASERES --machine $MACH --compset $CASESET --run-unsupported
cd  $CASEROOT

./xmlchange --append CAM_CONFIG_OPTS="-cppdefs '-DCBRAINDIAG -DBRAINDEBUG'" # CBRAINDIAG is necessary for 'partial coupling'
...
cb_do_ensemble = .true.
cb_ens_size = 7
cb_ens_fkb_model_list = ${ANNs}

cb_random_ens_size = 5
