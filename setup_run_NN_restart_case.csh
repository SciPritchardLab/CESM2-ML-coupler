...
#setenv CASE        CTRLrealgeographyonline003
#setenv CBRAIN "" # for CTRL cases.
setenv CASE        NNrealgeographyonline004-v11fit
#setenv CPPDEFS "-DCBRAIN"
#setenv CBRAIN "-DCBRAIN" # toggle for NN cases.
...
xmlchange --file env_run.xml --id RUN_STARTDATE --val 2007-04-02
xmlchange --file env_run.xml --id STOP_N --val 48
xmlchange --file env_run.xml --id run_data_archive --val "FALSE"

#restart stuff (testing):
xmlchange --file env_run.xml --id RUN_TYPE --val "branch"
xmlchange --file env_run.xml --id RUN_REFDIR --val "/scratch/07088/tg863871/CESM2_f19_v13_updated_NN_pelayout01_ens_07/run"
xmlchange --file env_run.xml --id RUN_REFCASE --val "CESM2_f19_v13_updated_NN_pelayout01_ens_07"
xmlchange --file env_run.xml --id RUN_REFDATE --val "2007-04-02"
...
cp /scratch/07088/tg863871/CESM2_f19_v13_updated_NN_pelayout01_ens_07/run/*.r*2007-04-02-00000* $SCRATCH/$CASE/run
cp /scratch/07088/tg863871/CESM2_f19_v13_updated_NN_pelayout01_ens_07/run/rpointer* $SCRATCH/$CASE/run
